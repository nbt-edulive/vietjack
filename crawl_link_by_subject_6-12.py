...
def extract_grade_from_url(url):
    ...
    Ví dụ: từ https://vietjack.com/series/lop-6.jsp -> lop-6
    """
    match = re.search(r'lop-([6-9]|1[0-2])', url)
    if match:
...
def extract_subject_links(url):
    ...
    nằm trong class="col-md-6", phân loại theo "Môn Ngữ văn" và "Môn Toán"
    ...
    try:
        ...
        for col in col_md_6_elements:
            ...
            if sub_title and sub_title.text:
                ...
                if 'Môn Ngữ văn' in title_text or 'Môn Tiếng Việt' in title_text:
                    current_subject = "ngu_van"
...
def main():
    ...
    grade_urls = [
        "https://vietjack.com/series/lop-6.jsp",
        "https://vietjack.com/series/lop-7.jsp",
        "https://vietjack.com/series/lop-8.jsp",
        "https://vietjack.com/series/lop-9.jsp",
        "https://vietjack.com/series/lop-10.jsp",
        "https://vietjack.com/series/lop-11.jsp",
        "https://vietjack.com/series/lop-12.jsp"
    ]
